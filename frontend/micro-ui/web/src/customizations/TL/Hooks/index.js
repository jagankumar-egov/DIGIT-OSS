...
/* To Oveeride any existing hook we need to use similar method */
...
/* Hook name */
const applicationDetails= async (t, tenantId, applicationNumber, userType) => {
...
const useApplicationDetail = (t, tenantId, applicationNumber, config = {}, userType) => {
  return useQuery(
    ...
    () => applicationDetails(t, tenantId, applicationNumber, userType),
    config
  );
};

const customize = () => { 
  // moduleName , hookName , hookFunction
