import { BackButton, Card, Header, SearchForm, Table, Loader,DownloadBtnCommon } from "@egovernments/digit-ui-react-components";
  ...
  return (
   ...
   <div style={{marginTop:"30px", marginLeft:"30px"}}>  <Header>{t("PRIVACY_AUDIT_REPORT")}</Header> </div>
      ...
      {data?.display ? (
        ...
        data !== "" ? (
        <div style={{ backgroundColor: "white", marginRight:"200px", marginLeft:"30px", width:"100%" }}>  
