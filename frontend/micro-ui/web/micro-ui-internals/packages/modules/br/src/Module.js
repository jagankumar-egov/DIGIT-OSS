...
import CustomDropdown from "./pagecomponents/CustomDropdown";
  ...
  const links = [
    {
      ...
      i18nKey: t("BR_Create_BirthRegistration"),
    },
  ];

  return <CitizenHomeCard header={t("BR_BirthRegistration")} links={links} Icon={() => <PTIcon className="fill-path-primary-main" />} />;
};
